...
import Demo   from '@/pages/Task-4/index.vue'
import DemoList   from '@/pages/Task-4/list.vue'
import DemoForm   from '@/pages/Task-4/form.vue'
...
export default new Router({
  ...
  routes: [
    ...
    { path: '/demo',      name: 'DemoList',     component: DemoList   },
